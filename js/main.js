...
function toggleDescription(button) {
    var hotelId = button.getAttribute('data-href');
    var descriptionContainer = document.getElementById('description-' + hotelId);
    var readMoreButton = button.querySelector('a');
    var isExpanded = descriptionContainer.classList.toggle('expanded');

    if (isExpanded) {
      
        descriptionContainer.style.webkitLineClamp = '2'; // Show only two lines
